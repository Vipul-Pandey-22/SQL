...
--- Insert these data on patients table
...
-----------------------------------------------------------------------------------
--- one more table 
--- Table name province_names

province_id	CHAR(2)
province_name	TEXT

--- Insert these data on province_names table
AB	Alberta
BC	British Columbia
MB	Manitoba
NB	New Brunswick
...
select 
    ...
    province_name 
from patients p 
	join province_names pn where p.province_id = pn.province_id;
